...
fun getSenators(stateOrDistrict: String): List<String> {
    val senatorsMap = mapOf(
        ...
        "Indiana" to listOf("Todd C. Young", "Jim Banks"),
        "Iowa" to listOf("Chuck Grassley", "Joni Ernst"),
        ...
        "Maryland" to listOf("Chris Van Hollen", "Angela Alsobrooks"),
        "Massachusetts" to listOf("Edward J. Markey", "Elizabeth Warren"),
        "Michigan" to listOf("Gary Peters", "Elissa Slotkin"),
        ...
        "Montana" to listOf("Steve Daines", "Tim Sheehy"),
        ...
        "New Jersey" to listOf("Cory Booker", "Andy Kim"),
        ...
        "Ohio" to listOf("Bernie Moreno", "Jon Husted"),
        "Oklahoma" to listOf("Alan Armstrong", "James Lankford"),
        "Oregon" to listOf("Jeff Merkley", "Ron Wyden"),
        "Pennsylvania" to listOf("David McCormick", "John Fetterman"),
        ...
        "South Carolina" to listOf("Darline Graham", "Tim Scott"),
        ...
        "Utah" to listOf("Mike Lee", "John Curtis"),
        ...
        "West Virginia" to listOf("Shelley Moore Capito", "Jim Justice"),
